...
describe("AuthController", () => {
  ...
  let sendAuthenticationTokensMock: jest.Mock;
  ...
  beforeEach(async () => {
    ...
    sendAuthenticationTokensMock = jest.fn();
    loginMock = jest.fn();
  ...
  it("should send OTP response if requiresOtp is true in userLogin", async () => {
    ...
    // Verifica che `sendAuthenticationTokens` non venga chiamato
    expect(sendAuthenticationTokensMock).not.toHaveBeenCalled();
  });
  ...
  it("should call getAuthResponseFromUserId and sendAuthenticationTokens for userLogin", async () => {
    ...
    // Verifica che `sendAuthenticationTokens` venga chiamato con i parametri corretti
    expect(sendAuthenticationTokensMock).toHaveBeenCalledWith(
      req,
      res,
      mockAuthResponse
    );
  ...
  describe("getUserProfile", () => {
    it("should fetch user profile from the service", async () => {
      ...
      expect(serviceMock.getUserProfile).toHaveBeenCalledWith(mockUserId);
  ...
  it("should clear refresh token cookie and call deleteUserProfile", async () => {
    ...
    // Verifica che `clearRefreshTokenCookie` venga chiamato
    expect(clearRefreshTokenCookieMock).toHaveBeenCalledWith(res);
